...
/**
 * Actprove lockup: chevron mark plus wide-tracked wordmark, white on black.
 * Uses the supplied SVG when it is present and falls back to the mark drawn
 * inline so the console never ships a broken image.
 */
export function Brand() {
  ...
  if (hasSvg) {
    ...
    return <img src={LOGO} alt="Actprove Defense Technologies" className="h-4 w-auto" />;
  }
  return (
